...
Due to the noise in the pictures and in the positioning sensors, the pairs of lines would not ever cut. So that, the application minimize the distance between those lines ( \ref{fig:line_min_dist} ). \\
...
\caption[line_min_dist]{Line minimal distance}
\label{fig:line_min_dist}
\end{figure}
